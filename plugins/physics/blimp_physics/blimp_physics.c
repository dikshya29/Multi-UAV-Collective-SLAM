...
DLLEXPORT void webots_physics_step()
{
	...
	rotBodyToFrame[0] = ode[0]; rotBodyToFrame[1] = ode[1]; rotBodyToFrame[2] = ode[2];
	rotBodyToFrame[3] = ode[4]; rotBodyToFrame[4] = ode[5]; rotBodyToFrame[5] = ode[6];
	rotBodyToFrame[6] = ode[8]; rotBodyToFrame[7] = ode[9]; rotBodyToFrame[8] = ode[10];
