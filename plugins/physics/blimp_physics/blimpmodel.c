...
void compDampingWrench(
		const dReal* inGenVelAB,
		dReal* genForceAB);		// computes damping wrench
void compRestoringWrench(
		const dReal* inGenPosA, 
		dReal* genForceAB);		// computes restoring wrench
void compCoriolisCor(
		const dReal* inGenVelAB,
		dReal* genForceAB);		// computes Coriolis added																						

//----------------------------------------------------------------------------//
// Model functions

void bmod_ComputeGenForces(
		const dReal* inGenPosA,
		const dReal* inGenVelAB,
		const dReal* inPropThrusts,	
		dReal* outGenForceAB)
{
...
void compCoriolisCor(const dReal* inGenVelAB, dReal* genForceAB)
{
	...
	genForceAB[0] += 	- b2b_m*inGenVelAB[2]*inGenVelAB[4] 
 										+ b2b_m*inGenVelAB[1]*inGenVelAB[5];
	genForceAB[1] += 	+ b2b_m*inGenVelAB[2]*inGenVelAB[3] 
 										- b2b_m*inGenVelAB[0]*inGenVelAB[5];
	genForceAB[2] += 	- b2b_m*inGenVelAB[1]*inGenVelAB[3] 
 										+ b2b_m*inGenVelAB[0]*inGenVelAB[4];
	// Coriolis added mass (added mass Coriolis gen. forces)
	genForceAB[0] += 	- b2b_addedMass[2]*inGenVelAB[2]*inGenVelAB[4] 
 										+ b2b_addedMass[1]*inGenVelAB[1]*inGenVelAB[5];
	genForceAB[1] += 	+ b2b_addedMass[2]*inGenVelAB[2]*inGenVelAB[3] 
 										- b2b_addedMass[0]*inGenVelAB[0]*inGenVelAB[5];
	genForceAB[2] += 	- b2b_addedMass[1]*inGenVelAB[1]*inGenVelAB[3] 
 										+ b2b_addedMass[0]*inGenVelAB[0]*inGenVelAB[4];
	genForceAB[3] += 	- b2b_addedMass[2]*inGenVelAB[2]*inGenVelAB[1] 
 										+ b2b_addedMass[1]*inGenVelAB[1]*inGenVelAB[2];
	genForceAB[4] += 	+ b2b_addedMass[2]*inGenVelAB[2]*inGenVelAB[0] 
 										- b2b_addedMass[0]*inGenVelAB[0]*inGenVelAB[2];
	genForceAB[5] += 	- b2b_addedMass[1]*inGenVelAB[1]*inGenVelAB[0] 
 										+ b2b_addedMass[0]*inGenVelAB[0]*inGenVelAB[1];
